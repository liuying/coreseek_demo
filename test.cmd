...
@ECHO. &&@ECHO 内容搜索：search  -c etc\%VERCONF% -a yuren
@search  -c etc\%VERCONF% -a yuren
...
@ECHO 指令：ECHO yrj ^| iconv -f gbk -t utf-8 ^| search -c etc\%VERCONF% --stdin ^| iconv -f utf-8 -t gbk
@ECHO.
@ECHO yrj | iconv -f gbk -t utf-8 | search -c etc\%VERCONF% --stdin | iconv -f utf-8 -t gbk
